...
async function integrationsPage() {
  ...
  content.innerHTML = '<div class="integration-grid"><section class="panel setting-panel voice-assistants wide"><h3>Voice Assistants</h3>' + localAssistantPanel(a) + (a.provider === 'openai-compatible' ? '' : assistantCard(a)) + '</section>' + cards + '</div>';
