...
CHECK(json_get_top_level_bool("{\"acoustic\\u005fevents\":true}",strlen("{\"acoustic\\u005fevents\":true}"),"acoustic_events",&v)==1&&v==1);
CHECK(json_get_top_level_bool("{\"usb\\u005fhost\":false}",strlen("{\"usb\\u005fhost\":false}"),"usb_host",&v)==1&&v==0);
CHECK(json_get_top_level_bool("{\"wrapper\":{\"acoustic\\u005fevents\":true}}",strlen("{\"wrapper\":{\"acoustic\\u005fevents\":true}}"),"acoustic_events",&v)==0);
CHECK(json_duplicate_key("{\"acoustic_events\":true,\"acoustic_events\":\"enabled\"}",strlen("{\"acoustic_events\":true,\"acoustic_events\":\"enabled\"}"),"acoustic_events"));
CHECK(json_duplicate_key("{\"acoustic_events\":true,\"acoustic\\u005fevents\":\"enabled\"}",strlen("{\"acoustic_events\":true,\"acoustic\\u005fevents\":\"enabled\"}"),"acoustic_events"));CHECK(json_get_top_level_bool("{\"acoustic_events\":true,\"acoustic_events\":\"enabled\"}",strlen("{\"acoustic_events\":true,\"acoustic_events\":\"enabled\"}"),"acoustic_events",&v)==-1);CHECK(json_get_top_level_bool("{\"acoustic_events\":true,\"acoustic\\u005fevents\":\"enabled\"}",strlen("{\"acoustic_events\":true,\"acoustic\\u005fevents\":\"enabled\"}"),"acoustic_events",&v)==-1);
CHECK(!json_duplicate_key("{\"wrapper\":{\"acoustic_events\":true,\"acoustic_events\":false}}",strlen("{\"wrapper\":{\"acoustic_events\":true,\"acoustic_events\":false}}"),"acoustic_events"));
