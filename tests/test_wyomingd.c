...
int main(void)
{
    ...
    {
        /* Home Assistant's Wyoming client refuses the whole info event when
           an advertised artifact omits attribution or installed metadata, so
           every section must carry them (issue #228). */
