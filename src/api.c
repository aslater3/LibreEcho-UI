...
static int button_sound_list_valid(const char *list)
{
    ...
    for (; *list; ++list) {
        if (*list == ',') {
            if (run == 0)
                return 0;      /* empty entry: ",," or a leading comma */
            run = 0;
            continue;
        }
