...
struct api_context{struct le_backend*backend;struct le_event_bus events;struct le_auth_db auth;int dev_controls,allow_insecure_lan,setup_completed,privacy_local_only,privacy_audio_retention,privacy_telemetry,privacy_crash_reports,privacy_log_hours,privacy_audio_retention_hours,privacy_audio_max_mb,net_ssh,net_api_lan;unsigned integrations,auth_failures;time_t auth_window_started,auth_blocked_until;char privacy_audio_mode[8],privacy_audio_remote_url[256];char button_short[32],button_long[32],auth_token[192],allowed_origin[256],csrf_token[65],config_path[384],users_path[384];char voice_pipeline_mode[24],stt_wyoming_uri[320],stt_wyoming_model[128],tts_wyoming_uri[320],tts_wyoming_voice[128];int stt_max_utterance_ms,stt_end_silence_ms,stt_vad_floor_rms;char timezone[64];int boot_estimate_seconds;int feature_simulation;struct le_radio_station{char word[32],name[64],url[512];int enabled;} radio[LE_MAX_RADIO_STATIONS];size_t radio_count;char logs[LE_MAX_LOGS][256];size_t log_count,log_next;};
