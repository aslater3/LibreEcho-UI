...
ADAPTER_TARGETS = $(BUILD)/libreecho-networkd $(BUILD)/libreecho-audiod $(BUILD)/libreecho-ledd $(BUILD)/libreecho-btd $(BUILD)/libreecho-airplayd
...
install: $(TARGET) $(LOGD_TARGET) adapters
	...
	install -m 0755 init/libreecho-web.init init/libreecho-logd.init init/libreecho-networkd.init init/libreecho-audiod.init init/libreecho-ledd.init init/libreecho-btd.init init/libreecho-airplayd.init $(DESTDIR)/etc/init.d/
